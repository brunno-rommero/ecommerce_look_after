                                ...
                                <div class=" required gn-row gn-billet-field <?php if ( $gn_billing_email_validate ) { ?> gn-hide <?php } ?>">
                                    ...
                                    <div class="gn-col-10">
                                        <input type="text" name="input-payment-billet-email"
                                               value="<?php echo $order->billing_email; ?>"
                                               id="input-payment-billet-email" class="form-control"/>
                                    </div>
                                </div>
                            ...
                            <div id="card-data">
                                <div class="gn-initial-section">
                                    ...
                                    <div class=" required gn-row gn-card-field <?php if ( $gn_billing_name_corporate_validate ) { ?> gn-hide <?php } ?>">
                                        ...
                                        <div class="gn-col-10">
                                            <input type="text" name="input-payment-card-name-corporate"
                                                   ...
                                                   value="<?php echo $gn_order_name_corporate; ?>"
                                                   class="form-control"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class=" required gn-row gn-card-field <?php if ( $gn_billing_cpf_cnpj_validate && $gn_billing_phone_number_validate ) { ?> gn-hide <?php } ?>">
                                        ...
                                        <div class="gn-col-4">
                                            <input type="text" name="input-payment-card-cpf-cnpj"
                                                   id="input-payment-card-cpf-cnpj"
                                                   value="<?php echo $gn_order_cpf_cnpj; ?>"
                                    ...
                                    <div class=" required gn-row gn-card-field <?php if ( $gn_billing_birthdate_validate ) { ?> gn-hide <?php } ?>">
                                        ...
                                        <div class="gn-col-3">
                                            <input type="text" name="input-payment-card-birth"
                                                   id="input-payment-card-birth"
                                    ...
                                    <div class=" required gn-card-field <?php if ( $gn_billing_email_validate ) { ?> gn-hide <?php } ?>">
                                        ...
                                        <div class="gn-col-10">
                                            <input type="text" name="input-payment-card-email"
                                                   value="<?php echo $order->billing_email; ?>"
                                                   id="input-payment-card-email" class="form-control"/>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="gn-col-10">
                                            <div class="gn-col-6 required">
                                                <input type="text" name="input-payment-card-address-street"
                                                       ...
                                                       value="<?php echo $order->billing_address_1; ?>"
                                                       class="form-control"/>
                                            </div>
                                            <div class="gn-col-6">
                                    ...
                                    <div class="gn-row gn-card-field <?php if ( $gn_billing_neighborhood_validate ) { ?> gn-hide <?php } ?>">
                                        ...
                                        <div class="gn-col-3">
                                            ...
                                            <input type="text" name="input-payment-card-neighborhood"
                                                   ...
                                                   value="<?php echo $order->billing_neighborhood; ?>"
                                                   class="form-control"/>
                                        </div>
                                        <div class="gn-col-7">
                                        ...
                                        <div class="gn-col-10">
                                            <div class="gn-col-4 required">
                                                ...
                                                <input type="text" name="input-payment-card-zipcode"
                                                       ...
                                                       value="<?php echo $order->billing_postcode ?>"
                                                       class="form-control"/>
                                            </div>
                                            <div class="gn-col-8">
                                                <div class=" required gn-left-space-2">
                                            ...
                                            <div class="gn-card-brand-selector">
                                                ...
                                                <div class="pull-left gn-card-brand-content">
                                                    <input id="mastercard" type="radio" name="input-payment-card-brand"
                                                           id="input-payment-card-brand" value="mastercard"
                                                           class="gn-hide"/>
                                                ...
                                                <div class="pull-left gn-card-brand-content">
                                                    <input id="diners" type="radio" name="input-payment-card-brand"
                                                           id="input-payment-card-brand" value="diners"
                                                           class="gn-hide"/>
                                    ...
                                    <div class="gn-row required">
                                        ...
                                        <div class="gn-col-12">
                                            <select name="input-payment-card-installments"
                                                    id="input-payment-card-installments"
                                                    class="form-control gn-form-select">
